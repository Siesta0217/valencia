...
public final class Modules {
    ...
    /**
     * The roster, in ClickGUI display order (grouped by category, same order
     * ModuleRegistry used to hand-write) — the GUI derives its panels from
     * this list directly. KEYED's relative order is a pure runtime concern
     * (the poll edge-detect array is rebuilt every launch), so regrouping is
     * safe.
     */
